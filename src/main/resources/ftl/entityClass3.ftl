...
import com.sankai.homecare.common.entity.BasicEntity;
import com.sankai.homecare.service.${className}Service;
import com.sankai.homecare.common.util.SpringUtils;
